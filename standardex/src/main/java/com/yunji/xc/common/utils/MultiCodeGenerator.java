...
//        dsc.setUrl("jdbc:mysql://localhost:3306/yjstandardex?useSSL=false&serverTimezone=GMT%2B8");
        ...
        pc.setParent("");
        pc.setEntity("com.yunji.xc.module." + packageConfig.getModuleName() + ".entity");
        pc.setMapper("com.yunji.xc.module."  + packageConfig.getModuleName() + ".mapper");
        pc.setService("com.yunji.xc.module."  + packageConfig.getModuleName() + ".service");
        pc.setServiceImpl("com.yunji.xc.module."  + packageConfig.getModuleName() + ".service.impl");
        pc.setController("com.yunji.xc.module." + packageConfig.getModuleName() + ".controller");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/resources/mapper/module/"
        ...
        focList.add(new FileOutConfig("/templates/controller.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/src/main/java/com/yunji/xc/module/"
                        + packageConfig.getModuleName() + "/controller/" + tableInfo.getEntityName() + "Controller" + StringPool.DOT_JAVA;
            }
        });
