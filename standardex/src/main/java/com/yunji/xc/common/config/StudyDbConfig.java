...
public class StudyDbConfig {
    ...
    static final String BASE_PACKAGE = "com.yunji.xc.module.study.mapper";

    private static final String MAPPING_LOCATION = "classpath:mapper/module/study/**/*.xml";
...
//        factoryBean.setConfiguration(studyGlobalConfig);
